...
namespace Backend.Repository.ProductRepository
{
    public class ProductRepository:IProduct
    {
        ...
        public Task<IEnumerable<Product>> SearchProduct(string productString)
        {
        ...
        {
            string FilterByExpiryDate = "exec GetExpiredProducts";
            return await context.Products.FromSqlRaw(FilterByExpiryDate).ToListAsync();
